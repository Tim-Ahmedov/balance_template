...
3. Запустите проект:
   ...
   - Приложение будет доступно на http://localhost:8080/worker-test/balances (или другой порт, если изменён в docker-compose.yml).
...
В системе реализованы следующие типы операций с балансом:

- [DEBIT (Списание средств)](docs/DEBIT.md)
- [CREDIT (Зачисление средств)](docs/CREDIT.md)
- [TRANSFER (Перевод средств)](docs/TRANSFER.md)
- [LOCK (Блокировка средств)](docs/LOCK.md)
- [UNLOCK (Разблокировка/Списание заблокированных средств)](docs/UNLOCK.md)

Каждая страница содержит подробное описание логики работы соответствующей операции.
